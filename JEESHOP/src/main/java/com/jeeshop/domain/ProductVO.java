...
public class ProductVO {
	...
	public String toString() {
		return "ProductVO [pro_num=" + pro_num + ", cate_code=" + cate_code + ", cate_prtcode=" + cate_prtcode
				+ ", pro_name=" + pro_name + ", pro_price=" + pro_price + ", discount=" + discount + ", pro_dev="
				+ pro_dev + ", pro_detail=" + pro_detail + ", pro_img=" + pro_img + ", pro_amount=" + pro_amount
				+ ", pro_buy=" + pro_buy + ", pro_date=" + pro_date + ", pro_update=" + pro_update + ", file1=" + file1
				+ "]";
	}
}
