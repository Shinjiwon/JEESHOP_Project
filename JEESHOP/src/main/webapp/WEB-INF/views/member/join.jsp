			...
			<form id="joinForm" action="/member/join" method="post">
				...
				<div class="regisfont">
					...
					<div class="form-group" style="width:100%;">
						...
						<input type="button" id="userIdChk" value="중복확인">
						<p id="id_availability" style="color: red;"/>
					</div>
					
					<div class="form-group">
						<label for="inputPassword">☞ 비밀번호</label> 
						<input type="password" class="form-control" id="mb_pw" name="mb_pw"
							   placeholder="비밀번호를 입력하세요." style="max-width: 630px;">
					</div>
					
					<div class="form-group">
						<label for="inputPasswordCheck">☞ 비밀번호 확인</label> 
						<input type="password" class="form-control" id="mb_pw_chk"
							placeholder="비밀번호 확인을 위해 다시한번 입력해 주세요." style="max-width: 630px;" >
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="mb_name" name="mb_name"
							   placeholder="이름을 입력하세요." style="max-width: 630px;">
					</div>
					
					<div class="form-group">
						<label for="inputNickName">☞ 닉네임</label> 
						<input type="text" class="form-control" id="mb_nick" name="mb_nick"
							   placeholder="사용할 닉네임을 입력하세요." style="max-width: 630px;">
					</div>
					
					<div class="form-group">
						<label for="InputEmail">☞ 이메일 주소</label><br/> 
						<input type="email" class="form-control" id="mb_email" name="mb_email" placeholder="이메일 주소를 입력해주세요"
							style="max-width: 526px; width:calc(100% - 115px); margin-right: 5px; 
							display: inline-block;">
						<input type="button" id="mbEmailChk" value="이메일 인증">
						<p id="authcode_status" style="color: red;"/>
					</div>
					...
					<div id="email_authcode" class="form-group" style="display: none;">
						...
						<input type="text" class="form-control" id="mbAuthcode" placeholder="이메일 인증코드" 
							style="max-width: 570px; width:calc(100% - 70px); margin-right: 5px; display: inline-block;" />
						<input type="button" id="btn_checkAuthCode" value="확인">
					</div>
					
					<div class="form-group">
						<label for="inputMobile">☞ 휴대폰 번호</label> 
						<input type="tel" class="form-control" id="mb_phone" name="mb_phone"
							   placeholder="휴대폰 번호를 입력하세요." style="max-width: 630px;">
					</div>
				...
				<div class="form-group text-center">
					<button type="button" id="btn_submit" class="btn btn-primary">회원가입 </button>
					<button type="button" id="btn_cancle" class="btn btn-warning">가입취소 </button>
				</div><br><br><br><br>
			</form>
		</div>
