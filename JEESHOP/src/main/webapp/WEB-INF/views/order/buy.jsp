		            ...
		            <c:forEach items="${productList}" var="productVO" varStatus="i">
		              <tr id="productVO_${productVO.pro_num}" class="productRow">
		                ...
		                <td>
			                ...
			                <input type="hidden" name="price_${productVO.cate_code}" value="${productVO.pro_price}" />
		                </td>
		                <td>
		                    ...
		                    <input type="hidden" name="discount_${productVO.cate_code}" value="${(productVO.pro_price)-(productVO.pro_price*(productVO.pro_discount*0.01))}" />    	
                       	</td>
		                <td>
		                <h5>${amounList[i.index]}</h5>
		                <input type="hidden" name="amount" value="${amounList[i.index]}">
		                </td>
		              </tr>
		              </c:forEach>
		              </tbody>
		      ...
		      <div class="orderInfo" style="min-width:1000px;" > 
					...
					<br><br><br><table class="table" style="text-align: center;">
			          ...
			          <div class="checkout_btn_inner" style="text-align: center;">
			            <br><button class="btn_1">결제하기</button>
			          </div>
				</div>
		      </div>
